...
public class Grid implements IGameObject {
    ...
    private void drawEndGameOverlay(Graphics2D graphicsRender) {
        ...
        if(winType == -1) {
            ...
            //won
            graphicsRender.drawString((winType == 0 ? "OPPONENT" : "MENACE") + " has won!", 175, 235);
        }

        graphicsRender.drawString("Press anywhere to restart! :)", 80, 260);
