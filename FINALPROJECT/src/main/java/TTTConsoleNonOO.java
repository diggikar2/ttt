...
public class TTTConsoleNonOO {
    ...
    /** The currentPlayer makes one move.
     Update board[selectedRow][selectedCol] and currentState. */
    public static void currentPlayerMove() {
        ...
        do {
            ...
            if (row >= 0 && row < ROWS && col >= 0 && col < COLS
                ...
                currentState = moveAndGetState(currentPlayer, row, col);
     ...
     */
    public static int moveAndGetState(int player, int selectedRow, int selectedCol) {
        // Update game board
